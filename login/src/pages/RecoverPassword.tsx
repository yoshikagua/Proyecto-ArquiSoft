          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full rounded-lg border bg-card py-3 pl-10 pr-4 text-sm text-foreground placeholder:text-muted-foreground transition-colors focus:outline-none focus:ring-2 focus:ring-ring ${
                  errors.email
