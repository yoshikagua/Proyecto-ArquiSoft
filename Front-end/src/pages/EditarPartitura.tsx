...
const EditarPartitura = () => {
    ...
    useEffect(() => {
        if (partitura) {
            ...
            reset({
                ...
                anio: partitura.anio,
                // Si tienes el formato en la partitura en tu type, úsalo. Si no, default o mock.
                // Como Partitura type no tiene formato, podríamos necesitar agregarlo o dejar vacío
                formatoAgrupacion: "Banda sinfónica", // Fallback, idealmente debería venir en Partitura
    ...
    // Determinar si hay cambios para habilitar botón
